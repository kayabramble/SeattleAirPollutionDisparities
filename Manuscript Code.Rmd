...
## Redlining region area
redlining_blocks_unique <- subset(redlining_blocks, !duplicated(redlining_blocks$block_key))
redlining_block_areas <- redlining_blocks_unique %>%
  left_join(all_block_areas, by=c("block_key"="BLOCKID10"))
sum(redlining_block_areas$area/1000000)

## Redlining grades area
redlining_grades_areas <- redlining_blocks %>%
  left_join(all_block_areas, by=c("block_key"="BLOCKID10"))
redlining_grades_areas$adj_area <- redlining_grades_areas$area/redlining_grades_areas$count
sum(redlining_grades_areas[redlining_grades_areas$holc_grade == "A", ]$adj_area/1000000)
sum(redlining_grades_areas[redlining_grades_areas$holc_grade == "B", ]$adj_area/1000000)
sum(redlining_grades_areas[redlining_grades_areas$holc_grade == "C", ]$adj_area/1000000)
sum(redlining_grades_areas[redlining_grades_areas$holc_grade == "D", ]$adj_area/1000000)
sum(redlining_grades_areas[redlining_grades_areas$holc_grade == "X", ]$adj_area/1000000)
